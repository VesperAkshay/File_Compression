...
class CompressionApp(QWidget):
    ...
    def create_file_type_tab(self, mode):
        ...
        for file_type in file_types:
            ...
            sub_layout.setContentsMargins(20, 20, 20, 20)  # Add margin around the tab
            ...
            input_file_btn.clicked.connect(lambda _, edit=input_file_edit: self.select_file(edit))
...
# Algorithm selection
            ...
            process_btn.clicked.connect(
                lambda _, m=mode, edit=input_file_edit, out_edit=output_file_edit, alg_combo=algorithm_combo: self.process_file(m, edit.text(), out_edit.text(), alg_combo.currentText())
            )
    ...
    def process_file(self, mode, input_file, output_file, algorithm):
        ...
        try:
            ...
            QMessageBox.information(self, 'Success', f'File {mode.lower()}ed successfully and saved to {output_file}')
